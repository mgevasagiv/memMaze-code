...
dataFolder = 'C:\Users\mgeva\Box\iEEG_MAZE_project\DATA\PATIENT DATA\DA26\MayaMaze';
edfFilename = fullfile(dataFolder, 'DA026_Maya_Maze_2.EDF');
...
for iif = 2:length(list)
    ...
    id_rmv = strfind(electName,"'");
    if ~isempty(id_rmv)
    electName = electName([[1:id_rmv-1],[id_rmv+1:length(electName)]]);end
