...
MatlabPathMaya();
rmpath(genpath('C:\Users\mgeva\Documents\GitHub\DML_QA\vendors\spm8\spm8\'))
...
dataFolder = 'C:\Users\mgeva\Box\iEEG_MAZE_project\DATA\PATIENT DATA\DA049';

edfFilename = fullfile(dataFolder, 'da049_maze_task.EDF');
...
% -----
% 8/5 - need to review macromontage before renaming channels 
% -----
